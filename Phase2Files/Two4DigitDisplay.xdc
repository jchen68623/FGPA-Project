...
##Assign Reset
set_property PACKAGE_PIN N17 [get_ports Reset_Clk]
set_property IOSTANDARD LVCMOS33 [get_ports Reset_Clk]
set_property PACKAGE_PIN M17 [get_ports Reset_Datapath]
set_property IOSTANDARD LVCMOS33 [get_ports Reset_Datapath]
